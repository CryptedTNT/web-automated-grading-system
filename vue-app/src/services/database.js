/* ============================================================
   ...
   Ported from js/database.js unchanged except for this ES module
   wrapper. The logic is storage-agnostic, so if this system later
   moves to a hosted database the call sites stay the same and only
   the bodies below change.

   NOTE (thesis): the SHA-256 password hashing below runs in the
   browser and the hash is stored in localStorage. That is a
   prototype measure, not real authentication — anyone with access
   to the browser can read it. Real auth requires a backend.
   ============================================================ */
